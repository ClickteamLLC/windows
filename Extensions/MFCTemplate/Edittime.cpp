...
//		edPtr->sheight = 32;
		...
		// Remove this and return 0 if your object does not need a setup
		// And remove the SetupDialog.ccp & .h files too
		CSetupDialog	dlg(mV, edPtr, CWnd::FromHandle(mV->mvHEditWin));
		if ( dlg.DoModal() == IDOK )
