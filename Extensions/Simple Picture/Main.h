...
// Object identifier "SAMP"

#pragma message ("************************ WARNING ****************************")
#pragma message ("***** Do not forget to change the IDENTIFIER in Main.h! *****")
#pragma message ("*************************************************************")

#define IDENTIFIER	MAKEID(S,A,M,P)		// REQUIRED: you MUST replace the letters in the MAKEID macro by others
...
// ---------------------------
#define	ACT_LOADFILE				0
#define	ACT_LAST					1

// -------------------------------
// DEFINITION OF EXPRESSIONS CODES
// -------------------------------
#define	EXP_GETFILENAME				0
#define	EXP_LAST                    1

// -------
// OPTIONS
// -------
#define	SPICTFLAGS_TRANSP_FIRSTPIXEL	1
...
typedef struct tagEDATA_V1
{
	...
	COLORREF		dwTranspColor;				// Transparent color
	char			sFilename[_MAX_PATH];		// filename
...
typedef struct tagRDATA
{
	...
	cSurface*		pSf;					// Picture surface
	LPSMASK			pColMask;				// Collision mask
...
// Default flags
// -------------
#define	OEFLAGS	(OEFLAG_SPRITES|OEFLAG_BACKSAVE|/*OEFLAG_INTERNALBACKSAVE|*/OEFLAG_MOVEMENTS|OEFLAG_VALUES )
