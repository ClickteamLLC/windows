...
FilenameCreateParam    fcp = { MAKEINTRESOURCE(IDS_ALLFILESFILTER), OFN_FILEMUSTEXIST | OFN_HIDEREADONLY };
...
PropData Properties[] = {
	...
	// Filename
	PropData_Filename	(PROPID_FILENAME,	IDS_PROP_FILENAME,	IDS_PROP_FILENAME_INFO,	&fcp),
...
void WINAPI DLLExport GetObjectRect(mv _far *mV, RECT FAR *rc, fpLevObj loPtr, LPEDATA edPtr)
{
	...
	rc->right = rc->left + 32;		// 32 = icon size
	rc->bottom = rc->top + 32;
